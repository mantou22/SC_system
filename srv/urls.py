...
from srv.my_view.stu_task_view import (StuTaskAdd, StuTaskDel, StuTaskEdit,
                                       StuTaskView, StuTaskSave, StuTaskFormalSave,
                                       TeaEditTask, StuTaskTeaViewList, StuTaskViewList, StuShowNotes)
...
urlpatterns = [
    ...
    url("^stu/task/tea/edit/$", TeaEditTask.as_view()),
    url("^stu/task/tea_view/list/$", StuTaskTeaViewList.as_view()),
    url("^stu/task/stu_view/list/$", StuTaskViewList.as_view()),
    url("^stu/task/show_notes/$", StuShowNotes.as_view()),
